  ...
  return (
    <div className="min-h-screen flex items-center justify-center" style={{ backgroundColor: 'hsl(220 15% 8%)' }}>
      <div style={{ width: '100%', maxWidth: '400px', padding: '0 1.5rem' }}>
        <h1 className="text-3xl font-bold text-white text-center" style={{ marginBottom: '2rem' }}>Log in</h1>
        ...
        <div style={{ textAlign: 'center', marginTop: '1rem' }}>
          <Link to="/forgot-password" style={{ fontSize: '14px', color: 'hsl(var(--accent))', textDecoration: 'none' }}>
            Forgot password
          </Link>
        </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', margin: '1.5rem 0' }}>
          ...
          <span style={{ fontSize: '12px', color: '#6b7280', textTransform: 'uppercase', letterSpacing: '0.05em' }}>or</span>
          <div style={{ flex: 1, height: '1px', backgroundColor: 'rgba(255,255,255,0.1)' }} />
        </div>
        ...
        <p style={{ textAlign: 'center', marginTop: '1.5rem', fontSize: '14px', color: '#9ca3af' }}>
          ...
          <Link to="/signup" style={{ color: 'hsl(var(--accent))', textDecoration: 'none', fontWeight: 600 }}>Sign up</Link>
        </p>
      </div>
    </div>
  );
